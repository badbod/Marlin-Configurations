...
#define STRING_CONFIG_H_AUTHOR "BaDboD" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  16.9465
    #define DEFAULT_Ki   1.0895
    #define DEFAULT_Kd  65.9008
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 103.5374
  #define DEFAULT_bedKi 20.1650
  #define DEFAULT_bedKd 354.4084
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 800, 800, 20, 80 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 6000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 1000, 1000, 200, 8000 } // ...or, set your own edit limits
#endif
...
#define Z_PROBE_FEEDRATE_FAST (1.5 * 60)
...
#define PREHEAT_1_TEMP_HOTEND 145
